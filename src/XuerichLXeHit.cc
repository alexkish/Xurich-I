...
XuerichLXeHit::XuerichLXeHit(const XuerichLXeHit &hXuerichLXeHit):G4VHit()
{
	...
	m_pPreKinNrg = hXuerichLXeHit.m_pPreKinNrg;
	m_pPostKinNrg = hXuerichLXeHit.m_pPostKinNrg;
...
void XuerichLXeHit::Print()
{
	G4cout << "-------------------- LXe hit --------------------" 
		...
		//<< " KineticEnergyBefore: " << m_pPreKinNrg/keV << " keV"
		//<< " KineticEnergyAfter: " << m_pPostKinNrg/keV << " keV"
