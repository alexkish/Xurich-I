...
XuerichPrimaryGeneratorAction::XuerichPrimaryGeneratorAction()
{
	m_pParticleSource = new XuerichParticleSource();
...
void
XuerichPrimaryGeneratorAction::GeneratePrimaries(G4Event *pEvent)
{
...
//        << G4endl;
	...
	if(m_pParticleSource->GetExtStatus())
	  m_pParticleSource->ReadExtFile();
