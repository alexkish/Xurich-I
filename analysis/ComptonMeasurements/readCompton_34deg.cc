...
{	
	...
	TFile *tfile2 = new TFile("./plots/34deg_withLeadPipe50cm.root","READ");
	...
	TCanvas *c1 = new TCanvas("c1", "c1", 0, 0, 700, 500);
		...
		file1_E1all_1_res	->Rebin(7);
		file2_E1all_1_res	->Rebin(7);

		file1_E1all_1_res	->Scale(0.143);
		file2_E1all_1_res	->Scale(0.143);
	...
	TCanvas *c2b = new TCanvas("c2b", "NaI, true coincidence", 0, 0, 700, 500);
		...
		file1_E1_2_res	->Rebin(4);
		file2_E1_2_res	->Rebin(4);

		file1_E1_2_res	->Scale(0.25);
		file2_E1_2_res	->Scale(0.25);
	...
	TCanvas *c3a = new TCanvas("c3a", "LXe, all coincident events", 0, 0, 700, 500);
		...
		file1_E2_1	->Scale(0.25);
		file2_E2_1	->Scale(0.25);

		file1_E2_1	->GetXaxis()->SetRangeUser(0,170);
	...
	TCanvas *c3b = new TCanvas("c3b", "LXe, true coincidence", 0, 0, 700, 500);
		...
		file1_E2_2	->Scale(0.25);
		file2_E2_2	->Scale(0.25);

		file1_E2_2	->GetXaxis()->SetRangeUser(0,170);
