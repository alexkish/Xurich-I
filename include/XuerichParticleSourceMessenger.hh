...
class XuerichParticleSourceMessenger: public G4UImessenger
{
public:
	XuerichParticleSourceMessenger(XuerichParticleSource *pParticleSource);
	~XuerichParticleSourceMessenger();
...
private:
	...
	G4ParticleTable *m_pParticleTable;
     ...
     G4UIcmdWithAString         *m_pExtFileCmd;
