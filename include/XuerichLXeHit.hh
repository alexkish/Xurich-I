...
class XuerichLXeHit: public G4VHit
{
public:
	XuerichLXeHit();
	~XuerichLXeHit();
	XuerichLXeHit(const XuerichLXeHit &);
	const XuerichLXeHit & operator=(const XuerichLXeHit &);
	G4int operator==(const XuerichLXeHit &) const;
...
typedef G4THitsCollection<XuerichLXeHit> XuerichLXeHitsCollection;

extern G4Allocator<XuerichLXeHit> XuerichLXeHitAllocator;

inline void*
XuerichLXeHit::operator new(size_t)
{
	return((void *) XuerichLXeHitAllocator.MallocSingle());
}

inline void
XuerichLXeHit::operator delete(void *pXuerichLXeHit)
{
	XuerichLXeHitAllocator.FreeSingle((XuerichLXeHit*) pXuerichLXeHit);
}
