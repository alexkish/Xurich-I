#ifndef __XUERICHPPARTICLESOURCE_H__
#define __XUERICHPPARTICLESOURCE_H__
...
class XuerichParticleSource: public G4VPrimaryGenerator
{
public:
	XuerichParticleSource();
	~XuerichParticleSource();
...
public:
	...
	void SetParticleMomentumDirection(G4ThreeVector hMomentum) { m_hParticleMomentumDirection = hMomentum.unit(); }
	...
	G4bool ReadExtFile();
	G4bool GetExtStatus(){ return m_hExtStatus; }
...
private:
	...
	XuerichParticleSourceMessenger *m_pMessenger;
